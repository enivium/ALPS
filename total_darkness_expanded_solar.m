% total_darkness_expanded_solar.m
% ALPS simulation script for surface missions in total darkness with larger solar arrays
...
num_runs = 100;
num_years = 5;
output_dir = 'output/total_darkness_expanded_solar/';
time_step = 0.25;
long_time_step = 24;
coast_length = 24;
